...
export const drawEchoLayer = ({ ctx, centerX, centerY, maxRadiusPx, controls }: RadarDrawContext): void => {
  ...
  for (let i = 0; i < density; i++) {
    ...
    const pos = polarToCanvas(centerX, centerY, radius, bearing);
